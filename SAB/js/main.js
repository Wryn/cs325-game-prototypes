...
function create() {
	...
	p1_health = 10;
	p1_health_display = game.add.text(20, 60, "P1: " + p1_health);
	p1_health_display.addColor("#FFFFFF", 0);

	p2_health = 10;
    p2_health_display = game.add.text(970, 60, "P2: " + p2_health);
...
function update() {
	if(!game_over){
		...
		round_display .setText("Round " + round);
		...
		if(turn == 1){
			...
			switch(p1_selected[i]){
				...
				case 1: p1_damage = 4; p1_selection.loadTexture('sword'); break;
				case 2: p1_damage = 2; p1_selection.loadTexture('axe');p1_unblockable = true; break;
				case 3: p1_damage = 3; p1_selection.loadTexture('bow');p1_undodgable = true; break;
				case 4: p1_block = true; p1_selection.loadTexture('block'); break;
				case 5: p1_dodge = true; p1_selection.loadTexture('dodge'); break;
				default: break;
			...
			switch(p2_selected[i]){
				...
				case 1: p2_damage = 4; p2_selection.loadTexture('sword'); break;
				case 2: p2_damage = 2; p2_selection.loadTexture('axe'); p2_unblockable = true; break;
				case 3: p2_damage = 3; p2_selection.loadTexture('bow'); p2_undodgable = true; break;
				case 4: p2_block = true; p2_selection.loadTexture('block'); break;
				case 5: p2_dodge = true; p2_selection.loadTexture('dodge'); break;
				default: break;
			...
			if((!p1_dodge || p2_undodgable) && p2_damage > 0){
				...
				p1_health_display.setText("P1: " + p1_health);
			...
			if((!p2_dodge || p1_undodgable) && p1_damage > 0){
				...
				p2_health_display.setText("P2: " + p2_health);
