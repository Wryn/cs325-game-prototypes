...
function create() {
    ...
    startScreen = true;
    gameOver = false;
    start_display = game.add.text(540, 360, "Click to Start!");
    start_display.addColor("#FFFFFF", 0);
    start_display.anchor.setTo(0.5, 0.5);
    score = 0;
...
function update() {
    ...
    if (startScreen){
        ...
        lightAreaMouse.visible = false;
        lightAreaPlayer.visible = false;
        if(game.input.activePointer.leftButton.isDown){
            player.visible = true;
            lightAreaMouse.visible = true;
            lightAreaPlayer.visible = true;
            start_display.destroy();
            startScreen = false;
        }
    	...
    	if (!gameOver){
    		...
    		else if (distance(star, player, this) < 250) star.visible = true;
